...
<div class="wrapper-page">
    <div class="card-box">
        <div class="panel-heading">
            <h3 class="text-center"> Acesse <strong class="text-custom">D1 Modelo</strong></h3>
        </div>
    ...
    <div class="row">
        <div class="col-sm-12 text-center">
            <p>
                Desenvolvido por <a href="#" class="text-primary m-l-5"><b>D1 Sistemas</b></a>
            </p>
        </div>
    </div>
